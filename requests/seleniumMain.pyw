...
class urp_tools:
    ...
    def show_credit(self):
        ...
        for tr in trs:
            ...
            text += str(tds[0].text[: -5]) + "\t" + "  "  + (str(tds[1].text) if len(str(tds[1].text)) == 4 else str(tds[1].text) + "0") + "\t" + "  " + (str(tds[2].text) if len(str(tds[2].text)) == 4 else str(tds[2].text) + "0") + "\t" + "  " + (str(tds[3].text) if len(str(tds[3].text)) == 5 else str(tds[3].text) + "0") + "\n"
